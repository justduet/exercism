...
class Darts {
  // define the radii (used to determine boundaries)
  ...
  int score(double x, double y) {
    ...
    if      (result <= INNER_RADIUS)    pointScore = INNER_SCORE;
    else if (result <= MIDDLE_RADIUS)   pointScore = MIDDLE_SCORE;
    else if (result <= OUTER_RADIUS)    pointScore = OUTER_SCORE;
